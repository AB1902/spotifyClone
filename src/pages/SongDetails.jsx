...
const SongDetails = () => {
    ...
    const {data:songData,isfetching:isFetchingDetails}=useGetSongDetailsQuery({songid})
    ...
    if(isFetchingDetails||isFetchingRelatedSongs) return <Loader title='searching Song details' />
